...
public class TradeEnrichmentServiceTests : IDisposable
{
    ...
    [Fact]
    public void EnrichTrade_WithEmptyDate_ShouldLogErrorWithEmptyReason()
    {
        // Arrange
        var tradeInput = new TradeInputDto
        {
        ...
        errorLog.StructuredState.Should().NotBeNull();
        var state = errorLog.StructuredState!.ToDictionary(x => x.Key, x => x.Value);
        state.Should().ContainKey("Reason").WhoseValue.Should().Contain("empty");
    }

    [Fact]
    public void EnrichTrade_WithWhitespaceDate_ShouldLogErrorWithEmptyReason()
    {
        // Arrange
        var tradeInput = new TradeInputDto
        {
    ...
    [Fact]
    public void EnrichTrade_WithInvalidDate_ShouldLogWithEventId2()
    {
        // Arrange
        var tradeInput = new TradeInputDto
        {
        ...
        // EventId 2 distinguishes date validation errors from missing product warnings (EventId 1)
        errorLog.Id.Should().Be(new EventId(2));
    }
    ...
    [Fact]
    public void EnrichTrades_WithMixedValidAndInvalid_ShouldLogOnlyInvalidDates()
    {
        // Arrange
        var trades = new[]
        {
